...
Licence : **MIT** — Copyright (c) 2026 Fabrice Morel (cœur `dec406_v7` de F4EHY,
2020). Texte dans `LICENSE.moricef-upstream`. Des révisions amont antérieures
portaient une mention *CC BY‑NC‑SA* en en‑tête ; les fichiers ici sont alignés
sur le `LICENSE` MIT amont.
